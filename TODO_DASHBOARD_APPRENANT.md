...
- [ ] Remplacer les valeurs hardcodees d'academies/progression (`VTC 73%`, `IT 42%`) par des donnees backend.
...
- [ ] Ajouter une checklist de validation manuelle par role dans la documentation de deploiement (`custom-infra/docs/mission-openedx-lms-cms.md`).

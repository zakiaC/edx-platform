"""Tutor plugin: add CSP in Report-Only mode for LMS/CMS.

Goal:
- Observe CSP violations safely before any blocking rollout.
- Keep production traffic unaffected (Report-Only header).
"""
